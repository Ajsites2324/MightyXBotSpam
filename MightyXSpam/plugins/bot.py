...
MIG_PIC = ALIVE_PIC if ALIVE_PIC else "https://te.legra.ph/file/0f738af80bd579c37624a.jpg"

MIG_TEXT = ALIVE_TEXT if ALIVE_TEXT else "╚»★ 𝐀𝐉𝐄𝐄𝐓𝗫𝗦𝗽𝗮𝗺 𝗶𝘀 𝗛𝗲𝗿𝗲 ★«╝"
...
async def restart(e):
    if e.sender_id in SUDO_USERS:
        text = "𝗥𝗲𝘀𝘁𝗮𝗿𝘁𝗶𝗻𝗴 𝗬𝗼𝘂𝗿 𝐀𝐉𝐄𝐄𝐓 𓆩𝗫𓆪 𝗦𝗣𝗔𝗠 ... | Please Wait For Few Seconds."
